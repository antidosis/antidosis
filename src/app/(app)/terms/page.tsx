...
export default function TermsPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 md:px-8">
      ...
      <p className="text-[12px] text-[#7a6b4a] mb-4">$ cat /etc/antidosis/terms.txt</p>
      <h1 className="text-3xl font-bold mb-8">terms of service</h1>

      <div className="space-y-8 text-[15px] text-[#7a6b4a] leading-relaxed">
        <section>
          <h2 className="text-lg font-semibold text-[#e8c97c] mb-3">1. acceptance of terms</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#e8c97c] mb-3">2. description of service</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#e8c97c] mb-3">3. user accounts</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#e8c97c] mb-3">4. user conduct</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#e8c97c] mb-3">5. contracts and exchanges</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#e8c97c] mb-3">6. reviews and ratings</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#e8c97c] mb-3">7. pro subscriptions</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#e8c97c] mb-3">8. limitation of liability</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#e8c97c] mb-3">9. termination</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#e8c97c] mb-3">10. changes to terms</h2>
