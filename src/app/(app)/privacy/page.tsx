...
export default function PrivacyPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 md:px-8">
      ...
      <p className="text-[12px] text-[#7a6b5a] mb-4">$ cat /etc/antidosis/privacy.txt</p>
      <h1 className="text-3xl font-bold mb-8">privacy policy</h1>

      <div className="space-y-8 text-[15px] text-[#7a6b5a] leading-relaxed">
        <section>
          <h2 className="text-lg font-semibold text-[#e8d5a3] mb-3">1. information we collect</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#e8d5a3] mb-3">2. how we use your information</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#e8d5a3] mb-3">3. data storage and security</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#e8d5a3] mb-3">4. cookies and tracking</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#e8d5a3] mb-3">5. third-party services</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#e8d5a3] mb-3">6. your rights</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#e8d5a3] mb-3">7. data retention</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#e8d5a3] mb-3">8. children&apos;s privacy</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#e8d5a3] mb-3">9. changes to this policy</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#e8d5a3] mb-3">10. contact us</h2>
          <p>For privacy-related questions or data deletion requests, contact us at: <span className="text-[#e8d5a3]">privacy@antidosis.com</span></p>
        </section>
