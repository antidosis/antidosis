    ...
    <div className={cn("relative", className)}>
      ...
      {preview ? (
        <div className="relative inline-block">
          <img src={preview} alt="Preview" className="h-16 w-16 object-cover border border-[#2a2420] rounded-md" />
          {uploading && (
          ...
          <button type="button" onClick={clearPreview} className="absolute -top-1 -right-1 p-1 bg-[#12100e] border border-[#2a2420] text-[#7a6b5a] hover:text-[#e8d5a3] hover:border-[#f5a623] rounded-md transition-colors">
            <X className="h-3 w-3" />
          </button>
        </div>
      ) : (
